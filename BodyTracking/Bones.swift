...
//  BodyTracking
//
//  Created by Amitesh Sinha on 14/03/23.
//
...
enum Bones: CaseIterable {
    ...
    var jointFromName: String {
        ...
        case .spine7ToLeftShoulder: return "spine_7_joint"
        case .spine7ToRightShoulder: return "spine_7_joint"
            
        case .neck1ToSpine7: return "neck_1_joint"
        case .spine7ToSpine6: return "spine_7_joint"
        case .spine6ToSpine5: return "spine_6_joint"
